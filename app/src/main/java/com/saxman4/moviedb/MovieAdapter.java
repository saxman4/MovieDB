...
public class MovieAdapter
    ...
    // interface implemented by MovieFragment to respond
            ...
            itemView.setOnClickListener(
                    new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            clickListener.onClick(Movies.buildMovieUri(rowID));
                        }
                    }
            );
        }
    ...
    // MovieAdapter instance variables
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.setRowID(cursor.getLong(cursor.getColumnIndex(Movies._ID)));
